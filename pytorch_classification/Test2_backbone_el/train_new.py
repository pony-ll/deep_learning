...
def main(args):
    ...
    # 实例化模型
    model = ghostnet(num_classes=args.num_classes).to(device)
...
if __name__ == '__main__':
    ...
    # 数据集所在根目录
    # "E:/data/datasets/flower_photos"
    # "E:/data/datasets/image_traffic/train"
    # "E:/data/datasets/ImageNet_1K/train"
    img_root = "E:/data/datasets/ImageNet_1K/train"
