...
# 2022.11.06-Changed for main script for ghostnetv2 model
...
parser.add_argument('--space_to_depth', type=int, default=1, metavar='N',
                    help='space_to_depth rate (default: 1)')
parser.add_argument('--depth_to_space', type=int, default=1, metavar='N',
                    help='depth_to_space rate (default: 1)')
...
def main():
    ...
    model = create_model(args.model,num_classes=args.num_classes,width=args.width,dropout=args.drop,args=args)
