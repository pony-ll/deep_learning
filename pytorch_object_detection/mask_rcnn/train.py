...
from backbone import efficient_B0
...
def create_model(num_classes, load_pretrain_weights=True):
    ...
    backbone = efficient_B0(pretrain_path="D:\data\Weights\efficientnet_b0.pth", trainable_layers=3)
...
if __name__ == "__main__":
    ...
    # 训练数据集的根目录
    parser.add_argument('--data-path', default='D:\data\datasets\VOCdevkit', help='dataset')
    # 检测目标类别数(不包含背景)
